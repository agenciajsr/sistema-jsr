...
Stopped at: Concluido quick 260715-gmf (modal "Criar novo Lead" como Dialog central com tags e 4 abas) + migration 0021 APLICADA (crm_tags, crm_contato_tags, pais/numero/complemento/bairro). NENHUMA migration pendente. Falta so a env CRM_LEADS_TOKEN (so p/ a API de leads)
Resume file: None
